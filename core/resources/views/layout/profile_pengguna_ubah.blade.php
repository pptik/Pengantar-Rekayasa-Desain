    ...
    <div class="section blue lighten-2">
        <div class="container row" style="padding: 2em 0 1em 0">
            ...
            <div class="row">
                <div class="col s12">
                    <ul class="tabs">
                        <li class="tab col s3"><a href="{{url('user')}}/<?php echo $username;?>/profil"
                                                  target="_self">Profil</a></li>
                        <li class="tab col s3"><a class="active">Ubah</a></li>
                        <li class="tab col s3"><a href="{{url('user')}}/<?php echo $username;?>/keamanan"
                                                  target="_self">Keamanan</a>
                        </li>
                    </ul>
                </div>
                <div id="test1" class="col s12 ">
                    ...
                    <ul class="collection with-header white">
                        <form class="col s12 m12 white" method="post" action="{{url('/ubah_profile')}}"
                              enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                            <li class="collection-item" style="margin: 0.5em;">
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input value="<?php echo $nama_depan;?>" id="nama_depan" type="text"
                                               class="validate" name="nama_depan">
                            ...
                            <li class="collection-item" style="margin: 0.5em;">
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input value="<?php echo $nama_belakang;?>" name="nama_belakang"
                                               id="nama_belakang" type="text" class="validate">
