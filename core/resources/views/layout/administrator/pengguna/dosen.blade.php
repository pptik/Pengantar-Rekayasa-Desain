        ...
        <div class="ui grid">
            <div class="four wide column">
                <div class="ui vertical pointing menu">
                    ...
                    <a class="active item" href="{{url('administrator/pengguna/dosen')}}">
                        Dosen
                    </a>
            ...
            <div class="twelve wide column">
                ...
                <table class="ui celled table" id="pengguna-mahasiswa">
                    ...
                    <tr>
                        <td><?php echo $no;?></td>
                    <!--<td class="table-id-user"><?php echo $dosen->id_user;?></td>
                        <td class="table-username"><?php echo $dosen->username;?></td>-->
                        <td class="table-id-user" style="display: none;"><?php echo $dosen->id_user;?></td>
                        <td class="table-email"><?php echo $dosen->email;?></td>
                        <td>
