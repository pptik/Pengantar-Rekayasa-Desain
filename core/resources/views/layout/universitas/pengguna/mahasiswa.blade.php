        ...
        <div class="row container">
            ...
            <div class="col s12">
                ...
                <div class="row">
                    <div class="col s12">
                        <ul class="tabs">
                            <li class="tab col s3"><a class="active">Mahasiswa</a></li>
                            <li class="tab col s3"><a href='{{url('universitas/dosen')}}'
                                                      target="_self">Dosen</a></li>
                        </ul>
                    </div>
                    <div id="test1" class="col s12 ">
                        ...
                        <table class="highlight" id="table_id">
                            ...
                            <tr class="danger">
                                ...
                                <td>
                                    <?php
                                    if ($mahasiswa->url_kartu_pengenal != NULL) {
                                        echo "<a href='" . $mahasiswa->url_kartu_pengenal . "' target='_blank'>Lihat</a>";
                                    } else {
                                        echo "-";
                                    }
                                    ?>
                                ...
                                <td>
                                    <?php
                                    switch ($mahasiswa->status_konfirmasi) {
                                        case 0;
                                            //echo "<a class='waves-effect waves-light btn' href='".{{url('konfirmasi/".$mahasiswa->id_user."')}}."'>konfirmasi sekarang</a>";
                                            ?>
                                        <a class='waves-effect waves-light btn' href='{{url("konfirmasi/mahasiswa")}}/<?php echo $mahasiswa->id_user;?>'>konfirmasi sekarang</a>
<?php
                                            break;
                                        case 1;
