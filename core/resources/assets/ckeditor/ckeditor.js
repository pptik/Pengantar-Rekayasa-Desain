...
(function () {
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var p = "\x3c" + k + "\x3e", q = "\x3c/" + k + "\x3e", c = p + c.replace(d, function () {
                            return q + p
                        }) + q
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            enableHtml5Elements: function (a, b) {
                for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time videos".split(" "),
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
            ...
            table: 1,
            ul: 1
        }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, l = {}, k = {"#": 1}, q = {
            center: 1,
            dir: 1,
            noframes: 1
        };
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var t =
                        this.$.getBoundingClientRect(), g = f.$.documentElement, p = g.clientTop || d.$.clientTop || 0, x = g.clientLeft || d.$.clientLeft || 0, l = !0;
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, y = c.endOffset, r, h = this.guard, n = this.type, m = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var z = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), B = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(y) : f.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !z.equals(a)) && (!B || !a.equals(B)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var E = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), g = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), l = CKEDITOR.dom.walker.bookmark(), k = CKEDITOR.dom.walker.temp(), q = function (a) {
    ...
    (function () {
        ...
        var g = {
            ...
            u: 1,
            "var": 1
        }, l = CKEDITOR.dom.walker.bogus(), k = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, q = CKEDITOR.dom.walker.editable(), w = CKEDITOR.dom.walker.ignored(!0);
            ...
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var q, Q, v = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), I = null, J = function (a) {
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), e = this.startContainer, p = this.endContainer, g = this.startOffset, l = this.endOffset, k = 1, r = 1;
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, p = d.block, g = null;
    ...
    (function () {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var n = this, e = [], m = this.editor && this.editor.config.protectedSource, f, g = !1, p = {
                    doFilter: !c,
                    doTransform: !0,
                    doCallbacks: !0,
                    toHtml: b
        ...
        var Q = {styles: 1, attributes: 1, classes: 1}, v = {
            ...
            }, I = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, J = {
                styles: /{([^}]+)}/,
                attrs: /\[([^\]]+)\]/,
                classes: /\(([^\)]+)\)/
    ...
    (function () {
        ...
        function y(a) {
            ...
            if (e)var n = new RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(n, "");
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (g, l, k) {
                ...
                var D = new CKEDITOR.htmlParser, p = l instanceof CKEDITOR.htmlParser.element ? l : "string" == typeof l ? new CKEDITOR.htmlParser.element(l) : new CKEDITOR.htmlParser.fragment, x = [], G = [], u = p, r = "textarea" == p.name, h = "pre" == p.name;
                D.onTagOpen = function (e, m, f, g) {
                    ...
                    if (a(m))x.push(m); else {
                        ...
                        if ("br" == e)G.push(m); else {
                            for (; !(g = (f = u.name) ? CKEDITOR.dtd[f] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, m.isUnknown || u.isUnknown || g[e]);)if (u.isOptionalClose)D.onTagClose(f); else if (e in b && f in b)f = u.children, (f = f[f.length - 1]) && "li" == f.name || y(f = new CKEDITOR.htmlParser.element("li"), u), !m.returnPoint && (m.returnPoint = u), u = f; else if (e in CKEDITOR.dtd.$listItem && !t(e, f))D.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (f in d && !t(e, f))!m.returnPoint && (m.returnPoint = u), u = u.parent; else if (f in CKEDITOR.dtd.$inline && x.unshift(u), u.parent)y(u, u.parent, 1); else {
                                m.isOrphan = 1;
                                break
                            }
                            q(e);
    ...
    (function () {
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, g = Array.prototype.slice.call(arguments, 1), l = this.rules, k = l.length, q, w, f, y;
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, h, c = p(c, b), c = f(c, T), c = w(c), c = f(c, R), c = c.replace(v, "$1cke:$2"), c = c.replace(J, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
        ...
        var x = /(?:&nbsp;|\xa0)$/, G = "{cke_protected}", u = CKEDITOR.dtd, r = "caption colgroup col thead tfoot tbody".split(" "), h = CKEDITOR.tools.extend({}, u.$blockLimit,
            u.$block), n = {
            elements: {
                input: k,
                textarea: k
        ...
        var E = /<(a|area|img|input|source)\b([^>]*)>/gi, C = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, H = /^(href|src|name)$/i, R = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            T = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, Q = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, v = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, I = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, J = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, l) {
            var k = this.container, q = this.ui.space("contents"), w = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement;
            ...
            return function (p, v, I, J) {
                ...
                if (!J.checkReadOnly()) {
                    ...
                    if (H) {
                        ...
                        var P, W;
                        v = y.startContainer;
                        var L = p.endPath.elements[0], X, K = L.getPosition(v), x = !!L.getCommonAncestor(v) && K != CKEDITOR.POSITION_IDENTICAL && !(K & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        v = b(p.dataWrapper, p);
        ...
        u = function () {
            ...
            return {
                list: {
                    ...
                    function a(c) {
                        var e = [], f, h = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d), m = c.endPath().contains(d), n = {};
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var f = e.document, h = CKEDITOR.document, g = e.editable(), n = f.getBody(), k = f.getDocumentElement(), q = g.isInline(), v, I;
    ...
    (function () {
            ...
            if (c.collapsed)f = G(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                for (t.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                    ...
                    if (t.equals(w))t = null, k = !0; else {
                        var y = t.type == CKEDITOR.NODE_ELEMENT ? t.getName() : null, u = y && "false" == t.getAttribute("contentEditable"), x = y &&
        ...
        var z = {
            ...
            audio: 1,
            video: 1
        }, E = /\s*(?:;\s*|$)/, C = /#\((.+?)\)/g, H = CKEDITOR.dom.walker.bookmark(0, 1), R = CKEDITOR.dom.walker.whitespaces(1);
        ...
        var T = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED, Q = CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED
    })();
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, l = c[d ? "endContainer" : "startContainer"], k = d ? "endOffset" : "startOffset", q = g ? c.document.getById(a.startNode) : a.startNode;
